...
import { getRelatedRecipes, cutDescription } from "../utils/elaborateDescription";
        ...
        <div>
            ...
            {recipe.dishTypes.length > 0 && (
                <div>
                    ...
                    <ul>
                        {recipe.dishTypes.map((occasion, i) => <li key={i}>{occasion}</li>)}
                    </ul>
                </div>
            )}
            {recipe.cuisines.length > 0 && (
                <div>
                    ...
                    <ul>
                        {recipe.cuisines.map((cuisine, i) => <li key={i}>{cuisine}</li>)}
                    </ul>
                </div>
            )}
            {recipe.occasions.length > 0 && (
                <div>
                    ...
                    <ul>
                        {recipe.occasions.map((occasion, i) => <li key={i}>{occasion}</li>)}
                    </ul>
                </div>
            )}
            <div>
